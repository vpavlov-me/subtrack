      ...
      <div className="flex-1 flex flex-col">
        ...
        <section className="flex-1 flex items-center justify-center px-4 bg-gradient-to-b from-zinc-50 to-white dark:from-zinc-900 dark:to-zinc-950">
          <div className="max-w-4xl text-center space-y-6">
            <Badge variant="secondary" className="mx-auto w-max">
              С заботой о фрилансерах и малом бизнесе
            </Badge>
            ...
            <p className="text-zinc-600 dark:text-zinc-400 text-lg max-w-2xl mx-auto">
              SubTrack автоматически напоминает о грядущих платежах
              и&nbsp;помогает оптимизировать ваши подписки.
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <Link
                to="/pricing"
                className="text-zinc-600 dark:text-zinc-400 hover:underline flex items-center gap-1 text-base"
              >
          ...
          <div className="max-w-5xl mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                <Card
                  key={f.title}
                  className="p-6 space-y-4 rounded-2xl border bg-zinc-50 dark:bg-zinc-900"
                >
              ...
              {[
                {
                  ...
                  quote:
                    'SubTrack сэкономил мне десятки часов и сотни долларов!',
                },
                {
                  name: 'Мария, владелец агентства',
                  quote:
                    'Мы наконец-то видим все подписки команды в одном месте.',
                },
              ].map(t => (
                <Card
                  key={t.name}
                  className="p-6 space-y-4 rounded-2xl border bg-white dark:bg-zinc-950"
                >
        ...
        <section className="py-24 bg-gradient-to-r from-indigo-500 to-purple-600 text-white">
          <div className="max-w-4xl mx-auto px-4 text-center space-y-6">
            ...
            <p className="text-lg opacity-90 max-w-2xl mx-auto">
              Зарегистрируйтесь сейчас и получите 14 дней полного доступа без
              ограничений.
            </p>
            <Link to="/register">
              <Button
                size="lg"
                variant="secondary"
                className="bg-white text-indigo-600 hover:bg-zinc-100 px-8 py-6 text-base"
              >
                Начать бесплатно
              </Button>
            </Link>
          ...
          <div className="max-w-6xl mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                <Card
                  key={u.title}
                  className="p-6 space-y-3 rounded-2xl border bg-zinc-50 dark:bg-zinc-900"
                >
                  <h3 className="text-xl font-semibold text-zinc-900 dark:text-zinc-100">
                    {u.title}
                  </h3>
          ...
          <div className="max-w-4xl mx-auto px-4 text-center space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[1, 2, 3, 4].map(i => (
                <div
                  key={i}
                  className="aspect-video rounded-xl bg-zinc-200 dark:bg-zinc-800 animate-pulse"
                />
              ))}
            </div>
          </div>
