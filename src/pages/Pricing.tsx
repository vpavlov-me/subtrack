...
const plans = [
  {
    ...
    price: '0',
    period: 'mo',
    features: ['До 50 подписок', 'Напоминания по email', 'Поддержка по email'],
      ...
      <div className="min-h-screen bg-zinc-50 dark:bg-zinc-900 py-24 px-4">
        <div className="max-w-4xl mx-auto text-center mb-16">
          ...
          <p className="text-zinc-600 dark:text-zinc-400 text-lg">
            Выберите план, подходящий вашему бизнесу. Отменить можно в любой
            момент.
          </p>
        </div>
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
          {plans.map(plan => (
            <Card
              key={plan.name}
              className="p-8 rounded-2xl border bg-white dark:bg-zinc-950 flex flex-col"
            >
              <div className="mb-6">
